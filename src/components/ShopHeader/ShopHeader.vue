<template>
  <div class="shop-header">
    <nav class="shop-nav"
      ...
      <a class="back">
        <i class="iconfont icon-arrow_left" @click="$router.back()"/>
      </a>
    </nav>
    <div class="shop-content" @click="isShowBrief=true">
    ...
    <transition name="showbrief">
      <div class="shop-brief-modal" v-show="isShowBrief">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer" @click="isShowBrief=false">
...
<style lang="stylus" rel="stylesheet/stylus" scoped>
  ...
  .shop-header
    ...
    .shop-brief-modal
      ...
      color #333
      &.showbrief-enter-active,&.showbrief-leave-active
        transition opacity 0.5s
      &.showbrief-enter,&.showbrief-leave-to
        opacity 0
      .brief-modal-cover
        position absolute
        width 100%
